...
from metrics.terrain_difficulty_analyzer import (
    TerrainDifficultyAnalyzer
)
from gazebo.world_exporter import (
    GazeboWorldExporter
)
...
class WorldGenerationPipeline:
    ...
    def _generate_obstacles(
        ...
        goal = (
            heightmap.shape[1] - 5.0,
            heightmap.shape[0] - 5.0
        )
    ...
    def _save_metadata(
        ...
        metadata = {
            ...
            "obstacle_generators": [
                ...
                for generator
                in self.obstacle_generators
            ],

            "difficulty": {

                "average_slope":
                    difficulty.average_slope,

                "maximum_slope":
                    difficulty.maximum_slope,

                "surface_roughness":
                    difficulty.surface_roughness,

                "obstacle_density":
                    difficulty.obstacle_density,

                "traversability_score":
                    difficulty.traversability_score,
